...
| 名前 | いつ | 何をする | トリガーID |
|---|---|---|---|
| モーニングリサーチv3 | 毎朝5時(JST) | 朝イチ候補リスト＋8カテゴリ調査 → Googleドライブ保存＋スマホ通知 | `trig_01GmdpacZ35wwucssCNwJ64i` |
| アフター検証 | 平日18時(JST) | 朝の候補を実際の値動きで答え合わせ → Excel台帳をドライブ保存＋通知 | `trig_01DLBQHiphRnW6xt7youHtNK` |
